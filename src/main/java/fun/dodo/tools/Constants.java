...
public final class Constants {
    ...
    public static final String STREAM_FORMAT = "application/octet-stream";
    ...
    public static final String MESSAGE_OWNERID_CONDITION = "OWNER ID 必须是大于 0 的整数";
    public static final String MESSAGE_NAME_CONDITION = "Name 不能为空";

    public static final String DATABASE_ACCESS_ERROR = "操作数据库失败";
